...
@Getter
public class ProjectSubmittedEvent extends BaseAuditEvent {
    
    private final Project project;
    
    public ProjectSubmittedEvent(Object source, Project project, User submitter) {
        super(source, "PROJECT_SUBMIT",
              "Submitted project: " + project.getName(),
              EntityType.PROJECT,
              project.getId(),
              submitter,
